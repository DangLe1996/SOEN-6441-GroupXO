...
//suhel ends
  ...
  public static Function<QueryResult,String> formatResult = (result) -> {
        try {
    ...
    public static CompletableFuture<QueryResult> invokeTwitterServer(Query query) throws TwitterException {
